...
const DEFAULT_TITLE = 'How Stablecoins are transforming Cross-Border Payments';
const DEFAULT_DESC =
  'Explore how stablecoins are enabling faster, cheaper, and more transparent global payments for modern businesses.';

const Hero = ({ title, desc }) => (
  <section className="boh-section">
    <div className="boh-frame">
      <img src={heroBg} alt="" className="boh-bg-img" aria-hidden="true" />
      <img src={heroBgMobile} alt="" className="boh-bg-img--mobile" aria-hidden="true" />
      <div className="boh-bg-tint" aria-hidden="true" />
      <div className="boh-ellipse" aria-hidden="true" />
      <div className="boh-inner">
        <div className="boh-badge-wrap">
          <div className="boh-badge">
            <span className="boh-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#boh-dots-a)">
                ...
                <defs>
                  <clipPath id="boh-dots-a"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
            <span className="boh-badge-text">
              <span className="boh-badge-text-inner">BLOG</span>
            </span>
            <span className="boh-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#boh-dots-b)">
                ...
                <defs>
                  <clipPath id="boh-dots-b"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
          </div>
        </div>
        <h1 className="boh-heading">{title || DEFAULT_TITLE}</h1>
        <p className="boh-desc">{desc || DEFAULT_DESC}</p>
      </div>
    </div>
  </section>
);
