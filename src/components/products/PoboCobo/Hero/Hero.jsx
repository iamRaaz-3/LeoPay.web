...
const pills = [
  { code: 'USD', flag: flagUsd, mod: 'usd' },
  { code: 'MMK', flag: flagMmk, mod: 'mmk' },
  { code: 'PHP', flag: flagPhp, mod: 'php' },
  { code: 'VND', flag: flagVnd, mod: 'vnd' },
];

const Hero = () => (
  <section className="pobo-hero">
    <div className="pobo-hero__inner">
      <div className="pobo-hero__glow" aria-hidden="true" />

      <div className="pobo-hero__stage">
        <div className="pobo-hero__content">
          <div className="pobo-hero__badge-wrap">
            <span className="pobo-hero__badge">
              <BadgeIconLeft />
              SOLUTIONS
              <BadgeIconRight />
            </span>
          ...
          <div className="pobo-hero__buttons">
            <GetStartedButton />
            <ApiDocsButton />
          </div>
        </div>

        <div className="pobo-hero__visual">
          <img src={heroCubes} alt="" aria-hidden="true" className="pobo-hero__cubes" />
          <span className="pobo-hero__halo" aria-hidden="true" />
          <img src={heroMark} alt="" aria-hidden="true" className="pobo-hero__mark" />
          {pills.map(pill => (
            <div key={pill.code} className={`pobo-hero__pill pobo-hero__pill--${pill.mod}`}>
              <img src={pill.flag} alt="" aria-hidden="true" className="pobo-hero__pill-flag" />
              <span className="pobo-hero__pill-label">{pill.code}</span>
            </div>
          ))}
        </div>
      </div>
