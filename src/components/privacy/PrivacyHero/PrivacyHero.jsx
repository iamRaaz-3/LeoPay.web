  ...
  <section className="prh-section">
    ...
    <div className="prh-inner">
      <div className="prh-badge">
        <span className="prh-badge-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
            <g clipPath="url(#prh-dots-a)">
            ...
            <defs>
              <clipPath id="prh-dots-a"><rect width="6" height="10" fill="white"/></clipPath>
            </defs>
          </svg>
        </span>
        <span className="prh-badge-text">
          <span className="prh-badge-text-inner">LEGAL</span>
        </span>
        <span className="prh-badge-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
            <g clipPath="url(#prh-dots-b)">
            ...
            <defs>
              <clipPath id="prh-dots-b"><rect width="6" height="10" fill="white"/></clipPath>
            </defs>
          </svg>
        </span>
      </div>
      <h1 className="prh-heading">Privacy Policy</h1>
