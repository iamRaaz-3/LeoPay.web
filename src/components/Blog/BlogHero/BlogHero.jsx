...
const BlogHero = () => (
  <section className="blh-section">
    <div className="blh-frame">
      <img src={heroBg} alt="" className="blh-bg-img" aria-hidden="true" />
      <img src={heroBgMobile} alt="" className="blh-bg-img--mobile" aria-hidden="true" />
      <div className="blh-bg-tint" aria-hidden="true" />
      <div className="blh-ellipse" aria-hidden="true" />
      <div className="blh-inner">
        <div className="blh-badge-wrap">
          <div className="blh-badge">
            <span className="blh-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#blh-dots-a)">
                ...
                <defs>
                  <clipPath id="blh-dots-a"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
            <span className="blh-badge-text">
              <span className="blh-badge-text-inner">BLOG</span>
            </span>
            <span className="blh-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#blh-dots-b)">
                ...
                <defs>
                  <clipPath id="blh-dots-b"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
          </div>
        </div>
        <h1 className="blh-heading">Blogs, Insights and Tips</h1>
        <p className="blh-desc">
          Explore expert articles, product updates, industry trends, and practical
          guidance for modern financial businesses.
        </p>
      </div>
    </div>
  </section>
