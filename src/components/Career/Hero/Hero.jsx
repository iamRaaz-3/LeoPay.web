...
const DEFAULT_TITLE = 'Become a part of our team';
const DEFAULT_DESC =
  'Join Leopay and be part of a team driving innovation, growth, and meaningful impact.';

const Hero = ({ title, desc }) => (
  <section className="chr-section">
    <div className="chr-frame">
      <img src={heroBg} alt="" className="chr-bg-img" aria-hidden="true" />
      <img src={heroBgMobile} alt="" className="chr-bg-img--mobile" aria-hidden="true" />
      <div className="chr-bg-tint" aria-hidden="true" />
      <div className="chr-ellipse" aria-hidden="true" />
      <div className="chr-inner">
        <div className="chr-badge-wrap">
          <div className="chr-badge">
            <span className="chr-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#chr-dots-a)">
                ...
                <defs>
                  <clipPath id="chr-dots-a"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
            <span className="chr-badge-text">
              <span className="chr-badge-text-inner">CAREERS</span>
            </span>
            <span className="chr-badge-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                <g clipPath="url(#chr-dots-b)">
                ...
                <defs>
                  <clipPath id="chr-dots-b"><rect width="6" height="10" fill="white"/></clipPath>
                </defs>
              </svg>
            </span>
          </div>
        </div>
        <h1 className="chr-heading">{title || DEFAULT_TITLE}</h1>
        <p className="chr-desc">{desc || DEFAULT_DESC}</p>
      </div>
    </div>
  </section>
);
