...
const BadgeIconLeft = () => (
  ...
  >
    <g clipPath="url(#badge-icon-left-clip)">
      <path
    ...
    <defs>
      <clipPath id="badge-icon-left-clip">
...
const BadgeIconRight = () => (
  <svg
    ...
    style={{ flexShrink: 0, opacity: "var(--opacity-100, 1)" }}
  >
    <g clipPath="url(#badge-icon-right-clip)">
      <path
    ...
    <defs>
      <clipPath id="badge-icon-right-clip">
        <rect width="6" height="10" fill="white" />
      </clipPath>
    </defs>
  </svg>
  ...
  <section className="partners-section">
    ...
    <div className="partners-row partners-row--top">
      <div className="partners-card">
        ...
        <div className="partners-stat">310+ Trusted Partners</div>
    ...
    <div className="partners-row partners-row--bottom">
      ...
      <div className="partners-card partners-card--right">
        ...
        <div className="partners-stat">71+ Payment Network</div>
